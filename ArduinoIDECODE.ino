...
// Light the selected LED for the specified duration
void toner(byte which, int duration_ms)
{
  setLEDs(which); //Turn on a given LED

  delay(duration_ms); // Keep the LED lit for the specified duration

  setLEDs(CHOICE_OFF); // Turn off all LEDs
}

// Play the winner light show
